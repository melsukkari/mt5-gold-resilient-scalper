...
from strategy import (GridManager, MarketFilter, MT5Connector, RiskManager,
                      TechnicalIndicators)
from web import auth_bp, set_trading_bot, web_bp
...
class TradingBot:
    ...
    def __init__(self):
        ...
        # Chart data cache
        self.chart_data_cache: Dict[str, Any] = {"labels": [], "prices": [], "ema": []}
    ...
    def get_full_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "risk_summary": (
                self.risk_manager.get_risk_summary(account_info) if account_info else {}
            ),
        }
