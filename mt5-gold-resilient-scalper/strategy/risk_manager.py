...
class RiskManager:
    ...
    def check_daily_loss_limit(
        ...
        daily_loss_percent = abs(daily_pnl) / self.daily_start_balance if daily_pnl < 0 else 0
    ...
    def check_max_positions(
        ...
        return (True, f"Position count OK ({current_positions}/{config.risk.MAX_OPEN_POSITIONS})")
